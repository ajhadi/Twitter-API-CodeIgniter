                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                      <ul class="nav navbar-nav">
                         ...
                         <li class="dropdown">
                          ...
                          <li class="dropdown">
                          <a href="<?php echo base_url();?>index.php/user_management"><span class="fa fa-group" aria-hidden="true"></span> User Management</a></li>
                          <li class="hidden-md hidden-lg"><a href="<?php echo base_url();?>index.php/auth/edit_user"><span class="fa fa-spin fa-cog"></span> Setting</a></li>
                      ...
                      <ul class="nav navbar-nav navbar-right hidden-sm hidden-xs">
                         <li class="sub-menu-parent">
                          ...
                          <ul class="sub-menu">
                            <li><a href="<?php echo base_url();?>index.php/auth/edit_user" target="_blank"><span class="fa fa-spin fa-cog" aria-hidden="true"></span> Setting</a></li>
